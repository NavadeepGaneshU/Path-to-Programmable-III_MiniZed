/*new version 26/08/2023*/
//Modified and updated by Navadeep (www.github.com/navadeepganeshu)
//Built on top of this tutorial - check @ www.hackster.io/Aritro
// Sensor used while demonstration (Pmod NAV, 10DOF)
import org.firmata.*;
...
{ 
  ...
  int m2x = 100; //m2.getMeterX();
  int m2y = 600; //m2.getMeterY();
  int m2w = 500; //m2.getMeterWidth();
  
  m3 = new Meter(this, m2x + m2w + 20, m2y);
  m3.setMeterWidth(700);
  m3.setTitleFontSize(20);
  m3.setTitleFontName("Arial bold");
  m3.setTitle("Pressure (HPa)");
  m3.setDisplayDigitalMeterValue(false);
  
  String[] scaleLabelsP = {"0", "950", "960", "970", "980", "990", "1000", "1010", "1020", "1030", "1040"};
...
{ 
  ...
  m.updateMeter(int(hum));
  m2.updateMeter(int(temp));
  m3.updateMeter(int(press));
}

void MakeAnglesDependentOnMPU6050() 
{ 
  Bank =-Phi/1.11; //-Phi/5 by default;
  Pitch=Theta*10;
  Azimuth=Psi;
}
void Horizon() 
...
{ 
  ...
  text("PATH TO PROGRAMMABLE-3 PROJECT - MiniZED", -450, 580, 800, 70);
