...
/********************************************************************************************/
#define DC_pin	1			// Channel 1
#define RST_pin	2			// Channel 2

void DC_OUTPUT(void)
{
	XGpio_SetDataDirection(&gpio1, DC_pin, 0x00);	// Set as output 0x00
}
void DC_LOW(void)
{
	XGpio_DiscreteWrite(&gpio1, DC_pin, 0x00);		// Clear output (LOW)
}
void DC_HIGH(void)
{
	XGpio_DiscreteWrite(&gpio1, DC_pin, 0x01);		// Clear output (LOW)
}

void RST_OUTPUT(void)
{
	XGpio_SetDataDirection(&gpio1, RST_pin, 0x00);	// Set as output 0x00

}
void RST_LOW(void)
{
	XGpio_DiscreteWrite(&gpio1, RST_pin, 0x00);		// Clear output (LOW)
}
void RST_HIGH(void)
{
	XGpio_DiscreteWrite(&gpio1, RST_pin, 0x01);		// Clear output (LOW)
